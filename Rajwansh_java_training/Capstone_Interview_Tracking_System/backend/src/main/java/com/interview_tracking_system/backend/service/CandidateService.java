...
public interface CandidateService {
     ...
     * @return the logged in CandidateUser
     */
    CandidateUser login(LoginRequestDTO request);

    /**
     * Submits the candidate profiling form for a job application.
     *
     * @param request         the profile details
     * @param candidateUserId extracted from JWT
     * @return the saved candidate response
     */
    CandidateResponseDTO applyToJob(CandidateProfileRequest request, String email);
